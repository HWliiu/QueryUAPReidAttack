# Code based on https://github.com/heshuting555/NAIC_Person_ReID_DMT/blob/master/utils/reranking.py
# """
...
def re_ranking(probFea, galFea, k1, k2, lambda_value):
    ...
    # print(
    #     'Using totally {:.2f}s to compute initial_rank'.format(
    #         time.time() - t1))
    ...
    # print(final_dist)
    # print(
    #     'Using totally {:.2f}S to compute final_distance'.format(
    #         time.time() - t1))
    return final_dist
