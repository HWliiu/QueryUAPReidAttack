# Code imported from https://github.com/KaiyangZhou/deep-person-reid/blob/master/torchreid/data/datasets/image/msmt17.py
...
class MSMT17(ReidImageDataset):
    ...
    def __init__(self, root='', **kwargs):
        ...
        main_dir = ''
        train_dir = TRAIN_DIR_KEY
        test_dir = TEST_DIR_KEY
