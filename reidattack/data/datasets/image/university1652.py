# Code imported from https://github.com/KaiyangZhou/deep-person-reid/blob/master/torchreid/data/datasets/image/university1652.py
import os
import glob
...
class University1652(ReidImageDataset):
    """University-1652.
