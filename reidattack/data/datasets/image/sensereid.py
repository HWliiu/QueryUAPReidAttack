# Code imported from https://github.com/KaiyangZhou/deep-person-reid/blob/master/torchreid/data/datasets/image/sensereid.py
import copy
import glob
...
class SenseReID(ReidImageDataset):
    """SenseReID.
