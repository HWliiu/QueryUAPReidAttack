# Code imported from https://github.com/KaiyangZhou/deep-person-reid/blob/master/torchreid/data/datasets/video/dukemtmcvidreid.py
import glob
import os.path as osp
import warnings

from .. import VIDEO_DATASET_REGISTRY
from ..bases import ReidVideoDataset
from ..utils import read_json, write_json


@VIDEO_DATASET_REGISTRY.register()
class DukeMTMCVidReID(ReidVideoDataset):
    """DukeMTMCVidReID.
