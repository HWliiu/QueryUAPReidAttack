...
class ReidDataset(Dataset):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.num_query_cams = self.get_num_cams(self.query)

        self.num_gallery_pids = self.get_num_pids(self.gallery)
        self.num_gallery_cams = self.get_num_cams(self.gallery)
        ...
        self.num_cams = self.get_num_cams(self.data)
        self.num_datasets = self.get_num_datasets(self.data)
...
class ReidImageDataset(ReidDataset):
    ...
    def __init__(self, train, query, gallery, **kwargs):
        super(ReidImageDataset, self).__init__(train, query, gallery, **kwargs)
...
class ReidVideoDataset(ReidDataset):
