...
from .backbones.my_custom_backbone import (
    vgg19, densenet121, shufflenetv2, mobilenetv2, inceptionv3,
    efficientnet_b0, regnet_x_1_6gf, convnext_tiny, vit_b_16)
